  ...
  return (
    <section className="relative min-h-screen flex items-center pt-28 pb-12 md:pt-36 md:pb-20 overflow-hidden bg-[#F2E8D8]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="lg:col-span-5 space-y-6 md:space-y-8 text-left flex flex-col items-start pt-10 md:pt-0">
          ...
          <div className="reveal mb-4 md:mb-6 flex flex-row flex-wrap gap-3 items-center">
            ...
            <div className="text-slate-700 text-sm md:text-[15px] space-y-4 font-normal leading-relaxed text-justify pr-0 lg:pr-4">
              <p>
              ...
              <p>
                Titulaire du <strong className="font-bold">DJCE – Diplôme de juriste conseil d’entreprise</strong>, formation exigeante et reconnue en droit des affaires, il est également titulaire du certificat d’études spécialisées en droit fiscal.
              </p>
              <p>
                Après plusieurs expériences professionnelles, notamment au sein des cabinets Fidal et Deloitte, ainsi qu’à la chambre fiscale du tribunal administratif de Montpellier, il a choisi de mettre cette expertise au service de sa clientèle personnelle à partir de 2026.
              </p>
              <p>
                Il accompagne principalement les dirigeants de TPE et de PME dans leurs problématiques juridiques et fiscales en intervenant principalement sur Montpellier et Perpignan.
              </p>
            </div>
          
          <div className="reveal flex flex-col sm:flex-row gap-4 md:gap-6 pt-4 w-full justify-start">
        ...
        {/* Right Side: Single Diaporama */}
        <div className="lg:col-span-7 hidden lg:flex justify-center lg:justify-end items-center">
          <div className="relative reveal aspect-[4/5] w-full max-w-lg group/diapo">
            ...
            {/* Dynamic Box */}
            <div className="absolute -bottom-8 left-8 bg-[#112056] p-6 lg:p-8 text-white shadow-2xl w-[75%] md:w-[70%] text-center transition-transform duration-700 group-hover/diapo:-translate-y-2 z-20">
              <p className="serif text-xl lg:text-2xl font-bold leading-tight text-white mb-2 tracking-tight whitespace-pre-line">
